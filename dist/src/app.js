...
export class App {
    ...
    registerModules = () => {
        ...
        personalJobRouter.get("/", (req, res) => personalJobController.getPersonalJobs(req, res));
        personalJobRouter.post("/", (req, res) => personalJobController.createPersonalJob(req, res));
