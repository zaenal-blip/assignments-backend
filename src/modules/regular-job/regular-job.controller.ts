...
import { RegularJobService } from "./regular-job.service.js";
import { AuthRequest } from "../../middleware/auth.middleware.js";
import { ApiError } from "../../utils/api-error.js";

export class RegularJobController {
  constructor(private regularJobService: RegularJobService) {}

  getRegularJobs = async (req: AuthRequest, res: Response) => {
    try {
  ...
  updateRegularJob = async (req: AuthRequest, res: Response) => {
    try {
  ...
  createRegularTask = async (req: AuthRequest, res: Response) => {
    try {
  ...
  deleteRegularJob = async (req: AuthRequest, res: Response) => {
    try {
      const id = Number(req.params.id);
